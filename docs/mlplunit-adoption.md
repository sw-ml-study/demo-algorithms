...
The full corpus is migrated: all 60 registered test files use shared `src/`
production definitions and native `@test` suites, and all 65 demos include the
...
The current suite reports 94 native tests/cases from 60 files. Forty files
