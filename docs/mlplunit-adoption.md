...
The full corpus is migrated: all 55 registered test files use shared `src/`
production definitions and native `@test` suites, and all 58 demos include the
...
The current suite reports 77 native tests/cases from 55 files. Forty files
