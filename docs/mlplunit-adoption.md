...
The full corpus is migrated: all 56 registered test files use shared `src/`
production definitions and native `@test` suites, and all 59 demos include the
...
The current suite reports 80 native tests/cases from 56 files. Forty files
