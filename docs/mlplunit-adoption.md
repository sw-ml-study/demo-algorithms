...
The full corpus is migrated: all 72 registered test files use shared `src/`
production definitions and native `@test` suites, and all 78 demos include the
...
The current suite reports 133 native tests/cases from 72 files. Forty files
