...
The full corpus is migrated: all 57 registered test files use shared `src/`
production definitions and native `@test` suites, and all 60 demos include the
...
The current suite reports 83 native tests/cases from 57 files. Forty files
