...
The full corpus is migrated: all 64 registered test files use shared `src/`
production definitions and native `@test` suites, and all 70 demos include the
...
The current suite reports 107 native tests/cases from 64 files. Forty files
