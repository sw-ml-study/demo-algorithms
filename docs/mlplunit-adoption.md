...
The full corpus is migrated: all 50 registered test files use shared `src/`
production definitions and native `@test` suites, and all 52 demos include the
...
The current suite reports 66 native tests/cases from 50 files. Forty files
