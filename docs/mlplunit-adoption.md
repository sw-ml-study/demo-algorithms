...
The full corpus is migrated: all 61 registered test files use shared `src/`
production definitions and native `@test` suites, and all 66 demos include the
...
The current suite reports 97 native tests/cases from 61 files. Forty files
