...
The full corpus is migrated: all 69 registered test files use shared `src/`
production definitions and native `@test` suites, and all 75 demos include the
...
The current suite reports 122 native tests/cases from 69 files. Forty files
