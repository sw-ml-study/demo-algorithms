...
The full corpus is migrated: all 51 registered test files use shared `src/`
production definitions and native `@test` suites, and all 53 demos include the
...
The current suite reports 68 native tests/cases from 51 files. Forty files
