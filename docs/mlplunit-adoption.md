...
The full corpus is migrated: all 58 registered test files use shared `src/`
production definitions and native `@test` suites, and all 62 demos include the
...
The current suite reports 87 native tests/cases from 58 files. Forty files
