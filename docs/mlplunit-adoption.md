...
The full corpus is migrated: all 77 registered test files use shared `src/`
production definitions and native `@test` suites, and all 83 demos include the
...
The current suite reports 148 native tests/cases from 77 files. Forty files
