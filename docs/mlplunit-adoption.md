...
The full corpus is migrated: all 59 registered test files use shared `src/`
production definitions and native `@test` suites, and all 64 demos include the
...
The current suite reports 91 native tests/cases from 59 files. Forty files
