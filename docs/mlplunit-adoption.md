...
The full corpus is migrated: all 78 registered test files use shared `src/`
production definitions and native `@test` suites, and all 84 demos include the
...
The current suite reports 151 native tests/cases from 78 files. Forty files
