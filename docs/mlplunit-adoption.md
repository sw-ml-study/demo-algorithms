...
The full corpus is migrated: all 80 registered test files use shared `src/`
production definitions and native `@test` suites, and all 86 demos include the
...
The current suite reports 157 native tests/cases from 80 files. Forty files
