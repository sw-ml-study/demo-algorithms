...
The full corpus is migrated: all 83 registered test files use shared `src/`
production definitions and native `@test` suites, and all 89 demos include the
...
The current suite reports 166 native tests/cases from 83 files. Forty files
