...
The full corpus is migrated: all 74 registered test files use shared `src/`
production definitions and native `@test` suites, and all 80 demos include the
...
The current suite reports 139 native tests/cases from 74 files. Forty files
