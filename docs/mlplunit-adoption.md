...
The full corpus is migrated: all 73 registered test files use shared `src/`
production definitions and native `@test` suites, and all 79 demos include the
...
The current suite reports 136 native tests/cases from 73 files. Forty files
