...
The full corpus is migrated: all 79 registered test files use shared `src/`
production definitions and native `@test` suites, and all 85 demos include the
...
The current suite reports 154 native tests/cases from 79 files. Forty files
