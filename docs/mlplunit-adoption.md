...
The full corpus is migrated: all 52 registered test files use shared `src/`
production definitions and native `@test` suites, and all 54 demos include the
...
The current suite reports 70 native tests/cases from 52 files. Forty files
