...
The full corpus is migrated: all 66 registered test files use shared `src/`
production definitions and native `@test` suites, and all 72 demos include the
...
The current suite reports 113 native tests/cases from 66 files. Forty files
