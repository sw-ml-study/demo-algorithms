...
The full corpus is migrated: all 65 registered test files use shared `src/`
production definitions and native `@test` suites, and all 71 demos include the
...
The current suite reports 111 native tests/cases from 65 files. Forty files
