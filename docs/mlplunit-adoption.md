...
The full corpus is migrated: all 63 registered test files use shared `src/`
production definitions and native `@test` suites, and all 69 demos include the
...
The current suite reports 104 native tests/cases from 63 files. Forty files
