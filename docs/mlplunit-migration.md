...
the contract: all 45 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 46 demos include those tested
