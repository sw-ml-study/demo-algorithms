...
the contract: all 59 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 64 demos include those tested
