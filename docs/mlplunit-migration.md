...
the contract: all 46 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 48 demos include those tested
