...
the contract: all 56 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 59 demos include those tested
