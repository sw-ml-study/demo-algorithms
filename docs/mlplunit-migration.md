...
the contract: all 63 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 69 demos include those tested
