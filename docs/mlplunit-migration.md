...
the contract: all 62 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 67 demos include those tested
