...
the contract: all 65 registered files execute shared production definitions
through native include and explicit `@test` registry suites. All 71 demos include those tested
