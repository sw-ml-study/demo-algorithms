...
| 8 | Tighten JSON/byte policies, then TOML and versioned native serialization | 4 | 4 | 2 | Deterministic JSON, numeric-byte persistence, and atomic replacement now run; higher-rank/Result semantics, limits, TOML, and typed native formats remain; see `serialization-acceptance.md` |
