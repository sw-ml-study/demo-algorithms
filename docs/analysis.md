...
| B-tree page index | nested immutable one/two-key pages | Runnable search and insertion with leaf/internal splits and root growth; deletion remains separate and structural sharing unguaranteed |
