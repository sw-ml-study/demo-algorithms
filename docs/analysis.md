...
0.20.0 build `c3eca9d7`, plus mlplunit `a06191f`,
...
| 8 | Tighten text/byte policies, then versioned native serialization | 4 | 4 | 2 | Deterministic JSON and TOML-subset round trips, numeric-byte persistence, and atomic replacement now run; higher-rank/Result semantics, limits, and typed native formats remain; see `serialization-acceptance.md` |
