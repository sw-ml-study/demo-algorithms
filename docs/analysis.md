...
0.20.0 build `533b69f8`, plus mlplunit `a06191f`,
...
| 8 | Tighten text/byte policies, then versioned native serialization | 4 | 4 | 2 | Deterministic JSON/TOML-subset round trips, byte/depth decode budgets, numeric-byte persistence, and atomic replacement now run; higher-rank/Result semantics, wider limits, and typed native formats remain; see `serialization-acceptance.md` |
